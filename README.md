...
<img src=/images/new_world_representation.png alt="drawing" width="90%"/>

- We also show that changes to the "world model", visualized by the linear probes, are causal with respect to the GPT next-move predictions. This is demonstrated for complex board changes in addition to single tile flips. By modifying the intervention scheme, we also show that in all cases, the causality of the world representation depends on the probe-layer.
<img src=/images/overview.png alt="drawing" width="90%"/>
<img src=/images/Example_intervention.png alt="drawing" width="90%"/>
<img src=/images/new_latent_saliency.png alt="drawing" width="90%"/>

- Lastly, we train several GPT models of different sizes (number of attention blocks and number of heads) and show that the causal world representation only appears for deep rather than shallow models. From these results, we hypothesize that although all models achieve nearly 100% accuracy in playing legal othello games, the (unsupervised) learned internal representations differs substantially by increasing the network depth. These findings suggest one possible interpretation for the generalizability of deep vs shallow attention-based large language models. 
<img src=/images/GPT_models.png alt="drawing" width="90%"/>
<img src=/images/linear_probes.png alt="drawing" width="90%"/>
<img src=/images/causal_intervention_comparison.png alt="drawing" width="90%"/>
